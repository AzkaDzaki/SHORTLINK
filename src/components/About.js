    ...
    return ( 
        <div className="home ">
            ...
            <div className="mb-10">
                ...
                <a href="#" className="cursor-pointer" onClick={() => {goTo('www.linkedin.com/in/azka-dzaki-arrazzaq/')}}><img src={ReactImg} style={{height: '48px', width: '55px'}} className="App-Home" alt="logo" /></a>
                </div>
            </div>    
            <div>
